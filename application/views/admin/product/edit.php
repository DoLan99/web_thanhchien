			...
			<div class="x_content">
				...
				<form id="demo-form2" method="post" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="col-md-9 col-sm-9 col-xs-12">
							<textarea name="description" class="resizable_textarea form-control" placeholder="Mô tả ngắn"><?php echo $product->description ?></textarea>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-3 col-sm-3 col-xs-12">
							<select class="select2_group form-control" name="category_id">
								<?php foreach ($categories as $category): ?>
									<option <?php echo $product->title == $category->id ? 'selected' : '' ?> value="<?php echo $category->id ?>">
					...
					<div class="form-group">
						...
						<div class="col-md-9 col-sm-9 col-xs-12">
							<img style="width: 100px; height: 100px; margin-right: 10px; margin-bottom: 10px; resize: cover" src="<?php echo public_url('images/product/') . $product->image; ?>" alt="">
					...
					<div class="form-group">
						...
						<div class="col-md-3 col-sm-3 col-xs-12">
							<select class="select2_group form-control" name="status">
								...
								<option <?php echo $product->status == 0 ? 'selected' : '' ?> value="0">DEACTIVE</option>
							</select>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-9 col-sm-9 col-xs-12">
							<input type="number" name="order_" value="<?php echo $product->order_ ?>" id="first-name" required="required" class="form-control col-md-7 col-xs-12">
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name">
						...
						<div class="col-md-9 col-sm-9 col-xs-12">
							<input value="<?php echo $product->tags ?>" type="text" name="tags" id="first-name" required="required" class="form-control col-md-7 col-xs-12">
						</div>
					</div>
