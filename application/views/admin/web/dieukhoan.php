				...
				<form id="demo-form2" method="post" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="col-md-9 col-sm-9 col-xs-12">
							<input type="text" name="title" id="first-name" value="<?php echo $dieu_khoan->title ?>" required="required" class="form-control col-md-7 col-xs-12">
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-md-3 col-sm-3 col-xs-12">
							<select class="select2_group form-control" name="status">
								<option <?php echo $dieu_khoan->status == 1 ? 'selected' : '' ?> value="1">ACTIVE</option>
								<option <?php echo $dieu_khoan->status == 0 ? 'selected' : '' ?> value="0">DEACTIVE</option>
							</select>
						</div>
					</div>
